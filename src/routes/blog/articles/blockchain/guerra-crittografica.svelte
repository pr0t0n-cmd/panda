...
<p>Nel paragrafo precedente abbiamo affermato che è "quasi impossibile" costruire una backdoor in un concetto come la crittografia a chiave pubblica. In realtà l'unico modo in cui la crittografia applicata potrebbe essere violata è se qualcuno è in grado di risolvere quello che viene chiamato il problema "P versus NP" (video esplicativo) 
 </p>

<p>Il concetto alla base è molto complicato da approfondire, ma essenzialmente se qualcuno potesse costruire un computer che sfida la fisica tradizionale alla base del calcolo moderno romperebbe i sistemi crittografici della nostra società. Teoricamente questo è possibile con i computer quantistici. Ma, sebbene questa tecnologia abbia fatto notevoli progressi, è ancora molto lontana da dove dovrebbe essere. Infine è altamente improbabile (non impossibile) che l'informatica quantistica venga sviluppata segretamente da un singolo stato poiché l'ingegneria, le risorse e le scoperte concettuali necessarie per il suo sviluppo sono considerate al di sopra persino di un possibile governo mondiale. </p>


<p>Se desideri saperne di più sul movimento Cypherpunk, puoi leggere questo <a href="https://www.wired.com/1993/02/crypto-rebels/">articolo</a> articolo della rivista Wired nel 1993.</p>
...
<p>Approfondimenti:</p> 
<p><a href="https://www.scientificamerican.com/article/nsa-nist-encryption-scandal/">Gli sforzi della NSA per eludere lo standard crittografico degli Stati Uniti danneggiato dalla tecnologia di crittografia</a>  Un pezzo sui tentativi della NSA di creare una backdoor negli standard crittografici negli anni '90.</p>

<p><a href="https://www.wired.com/1993/02/crypto-rebels/">"Crypto Rebels" (Wired, 1993)</a>
...
<p><a href="https://en.wikipedia.org/wiki/The_Hitchhiker%27s_Guide_to_the_Galaxy">Wiki: la guida per gli autostoppisti all'anonimato online</a>Nervoso per la privacy da parte dei governi? Questa è una guida estremamente dettagliata su come mantenere l'anonimato online. Avviso spoiler: è piuttosto impegnativo!</p>
